              ...
              <div class="product_buttons">
                <div class="text-right d-flex flex-row align-items-start justify-content-start">
                  <div
                    ...
                    <div>
                      <div><a class="add addPanier" href="addpanier.php?item_id=<?= $product->item_id;?>"><img src="../img/icones/panier.svg" class="svg" alt=""></a>
                        <div>+</div>
                      </div>
                    </div>
                  </div>
                  <div
                    ...
                    <div>
                      <div><a class="add addPanier" href="addpanier.php?id<?= $product->item_id;?>"><img src="../img/icones/payer.svg" class="svg" alt=""></a>
                        <div>+</div>
                      </div>
                    </div>
                  </div>
